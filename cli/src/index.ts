...
import {scaffoldExpoProject} from "~/helpers/scaffoldProject.js"; 
import { initializeGit } from "~/helpers/git.js";
import { logNextSteps } from "~/helpers/logNextSteps.js";
import { setImportAlias } from "~/helpers/setImportAlias.js";
import {buildPkgInstallerMap, InstallerOptions} from "~/installers/index.js";
...
const main = async () => {
  ...
  const {
    appName,
    packages,
    flags: { noGit, noInstall, importAlias, expo },
  } = await runCli();
